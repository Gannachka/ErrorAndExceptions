...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Student HannaMiki = new Student("Hanna Mikliyaeva", firstGroup, 1);
        ...
        students.add(HannaMiki);
        students.add(VladIlinov);
        students.add(DzenisBozhko);
        students.add(AndrewKozlovskiy);

        HannaMiki.getMarks().put("DataBases",new Integer[]{8,7,6,9,10});
        ...
        System.out.println("Средний балл студента " + HannaMiki.avgMarks());
